...
\begin{resume}
    ...
    \begin{list2}
        ...
        \item Led analytical components (including method development) of projects related to carbonyl quantification, aqueous phase reforming, bioslurries, bio-char surface characterization, GCxGC for functional group typing, and FTIR chemometrics.
...
%	\vspace{-4mm}
    ...
    Bulsink, P., and Makanda, U., ``PlotFTIR: Production of FTIR spectra plots in R'', \textit{Pending S\&T Pubs Process}
